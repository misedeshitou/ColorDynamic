...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--Env_dvc", type=str, default="cuda:0", help="running device for Sparrow Env"
    )
    parser.add_argument(
        "--A_dvc", type=str, default="cuda:0", help="running device for Actor"
    )
    parser.add_argument(
        "--B_dvc", type=str, default="cuda:0", help="running device for Buffer of Sharer"
    )
    parser.add_argument(
        "--L_dvc", type=str, default="cuda:0", help="running device for Learner"
    )

    # ASL training strategy configuration
    parser.add_argument("--exp_name", type=str, default="ColorDynamic_DQN_ASL", help="Experiment name")
    ...
    parser.add_argument(
        ...
        type=int,
        default=int(3e4),
        help="Random warm up total steps before training",
    )
    parser.add_argument(
        "--TPS",
        type=int,
        default=256,
        help="Transitions been trained Per single Step",
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Whether use time feedback mechanism",
    )
    parser.add_argument("--gamma", type=float, default=0.99, help="Discounted Factor")
    parser.add_argument("--lr", type=float, default=1e-4, help="Learning rate")
    parser.add_argument(
        "--clip", type=int, default=10, help="clip_grad_norm for model optimization"
    )
    parser.add_argument(
        "--soft_target", type=str2bool, default=False, help="Target net update mechanism"
    )
    parser.add_argument(
        "--save_freq", type=int, default=int(5e4), help="Model save frequency, in Bstep"
    )
    parser.add_argument(
        "--reset_freq",
        type=int,
    ...
    parser.add_argument(
        "--upload_freq", type=int, default=500, help="learner update freq, in Bstep"
    )

    # Vectorized e-greedy configuration
    parser.add_argument(
        "--init_explore_frac", type=float, default=1.0, help="init explore fraction"
    )
    parser.add_argument(
        "--end_explore_frac", type=float, default=0.2, help="end explore fraction"
    )
    parser.add_argument(
        "--decay_step",
        type=int,
        default=int(100e3),
        help="linear decay steps(total) for e-greedy noise",
    )
    parser.add_argument(
        "--min_eps", type=float, default=0.05, help="minimal e-greedy noise"
    )
    ...
    parser.add_argument(
        "--action_type", type=str, default="Discrete", help="Action type: Discrete / Continuous"
    )
    ...
    parser.add_argument(
        "--RdON", type=str2bool, default=False, help="whether to randomize the Number of dynamic obstacles"
    )
    parser.add_argument(
        "--ScOV", type=str2bool, default=False, help="whether to scale the maximal velocity of dynamic obstacles"
    )
    parser.add_argument(
        "--RdOV", type=str2bool, default=False, help="whether to randomize the Velocity of dynamic obstacles"
    )
    parser.add_argument(
        "--RdOT", type=str2bool, default=True, help="whether to randomize the Type of dynamic obstacles"
    )
    parser.add_argument(
        "--RdOR", type=str2bool, default=True, help="whether to randomize the Radius of obstacles"
    )
    ...
    parser.add_argument(
        "--MapObs", type=str, default=None, help="name of map file, e.g. 'map.png' or None"
    )
    ...
    parser.add_argument(
        "--ld_GN", type=int, default=3, help="how many lidar streams are grouped for each group"
    )
    parser.add_argument(
        "--ri", type=int, default=0, help="render index: the index of world that be rendered"
    )
    parser.add_argument(
        "--basic_ctrl_interval",
        type=float,
    ...
    parser.add_argument(
        "--draw_auxiliary", type=str2bool, default=False, help="whether to draw auxiliary infos"
    )
    ...
    parser.add_argument(
        "--noise", type=str2bool, default=True, help="whether to add noise to the observations"
    )
    parser.add_argument(
    ...
    share_manager = BaseManager()
    share_manager.start()
    opt.shared_data = share_manager.shared_data(opt)
