...
parser.add_argument('--ModelIndex', type=int, default=3150, help='which model to load')
...
def main():
    ...
    # Play
    while True:
        scores = evaluate_policy(env, agent, turns=3)
        print(f"Scores:{scores}\n")

        # test_ep_steps, test_ep_r, test_arrival_rate = evaluate(
        #     env, agent, deterministic=False, turns=1
        # )
        # print(
